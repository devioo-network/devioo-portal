<template>
  ...
  >
    ...
    >
      ...
      <form>
        <div class="mb-6">
          <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nom d'utilisateur</label>
          <input type="email" id="email" class="input" placeholder="pseudo cool" required>
        </div>
        <div class="mb-6">
