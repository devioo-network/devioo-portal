  ...
  >
    ...
    >
      ...
      <div class="flex w-full flex-col place-items-center">
        <button
          type="button"
          class="oauth-button dark:focus:ring-[#4285F4]/55 bg-[#4285F4] hover:bg-[#4285F4]/90 focus:outline-none focus:ring-4 focus:ring-[#4285F4]/50"
        >
          <svg
        ...
        <button
          type="button"
          class="oauth-button dark:hover:bg-[#050708]/3 bg-[#24292F] hover:bg-[#24292F]/90 focus:outline-none focus:ring-4 focus:ring-[#24292F]/50 dark:focus:ring-gray-500"
        >
          <svg
            class="mr-2 -ml-1 h-4 w-4"
            aria-hidden="true"
